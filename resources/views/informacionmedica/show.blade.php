...
@section('botones')
    ...
    <a href="{{route('informacionmedica.index')}}" class="btn btn-primary mr-2 text-white">
...
@section('content')
    <article class="contenido-hoja">
        <h1 class="text-center mb-4">{{$medica->name}}</h1>
        <div class="adjunto">
            <h2 class="my-3 text-dark">Adjunto:</h2>
            <a href="/storage/{{$medica->url}}">Ver adjunto</a>
        </div>
    </article>
@endsection
