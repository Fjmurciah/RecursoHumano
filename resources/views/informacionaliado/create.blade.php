...
@section('botones')
    ...
    <a href="{{route('infoaliado.index')}}" class="btn btn-primary mr-2 text-white">Atrás</a>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('infoaliado.store') }}" enctype="multipart/form-data" novalidate>
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="url" class="col-md-4 col-form-label text-md-end">Agregue documento de informacón aliado</label>
